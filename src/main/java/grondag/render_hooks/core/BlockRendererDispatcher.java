...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    public boolean renderBlockPipelined(IBlockState state, BlockPos pos, IBlockAccess blockAccess, BufferBuilder bufferBuilderIn)
    {
        if(PipelinedBlockModelRenderer.isPipelined(state)) 
            return PipelinedBlockModelRenderer.renderBlock(state, pos, blockAccess, bufferBuilderIn);
        else
            return renderBlock(state, pos, blockAccess, bufferBuilderIn);
    }
            ...
            else
            {
                ...
                switch (enumblockrendertype)
                {
                    case MODEL:
                        ...
                        return PipelineHooks.renderModel(this.blockModelRenderer, blockAccess, model, state, pos, bufferBuilderIn, true);
    ...
    public boolean renderBlock2(IBlockState state, BlockPos pos, IBlockAccess blockAccess, BufferBuilder bufferBuilderIn)
    {
        try
        {
            EnumBlockRenderType enumblockrendertype = state.getRenderType();
    ...
    public net.minecraft.client.renderer.BlockModelRenderer getBlockModelRenderer()
    {
