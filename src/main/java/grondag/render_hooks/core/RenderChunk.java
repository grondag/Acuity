...
public class RenderChunk
{
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator)
    {
        ...
        if (!this.worldView.isEmpty())
        {
            ...
            RenderMaterialBufferManager materials = AccessHelper.getMaterialBuffers(generator.getRegionRenderCacheBuilder());
            materials.prepare(blockpos);
            ...
            for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos.getAllInBoxMutable(blockpos, blockpos1))
            {
                ...
                materials.renderMaterials(iblockstate, blockpos$mutableblockpos, this.worldView);
...
//                        aboolean[j] |= PipelineHooks.renderBlock(blockrendererdispatcher, iblockstate, blockpos$mutableblockpos, this.worldView, bufferbuilder);
                    }
                }
